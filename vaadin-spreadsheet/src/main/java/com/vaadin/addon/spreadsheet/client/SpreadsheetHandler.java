...
public interface SpreadsheetHandler extends GroupingHandler {
     ...
     * @param firstColumnIndex column index for the selected cell (left most visible)
     */
    @Delayed
     ...
     * @param firstRowIndex row index for the selected cell (top most visible)
     */
    @Delayed
     ...
     *
     * @param firstRowIndex row index for the selected cell (top most)
     * @param column        the column that was selected
     */
    @Delayed
     ...
     *
     * @param r1 new selection top, 1-based
     * @param c1 new selection left, 1-based
     * @param r2 new selection bottom, 1-based
     * @param c2 new selection right, 1-based
     */
    @Delayed
     ...
     *
     * @param row topmost cell index where the clearing starts, 1-based
     * @param col leftmost cell index where the clearing starts, 1-based
     */
    @Delayed
     ...
     *
     * @param newRowSizes row index and new size (converted pt)
     * @param row1
     * @param col1
     * @param row2
     * @param col2
     ...
     * @param row2
     * @param col2
     * @param newColumnSizes column index and new size (px)
     */
